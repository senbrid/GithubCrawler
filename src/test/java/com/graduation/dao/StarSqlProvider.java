...
import com.graduation.model.StarExample.Criteria;
import com.graduation.model.StarExample.Criterion;
...
public class StarSqlProvider {
    ...
    public String insertSelective(Star record) {
        ...
        if (record.getStarlogin() != null) {
            VALUES("starLogin", "#{starlogin,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getStarlogin() != null) {
            SET("starLogin = #{record.starlogin,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Star record) {
        ...
        if (record.getStarlogin() != null) {
            SET("starLogin = #{starlogin,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(StarExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
